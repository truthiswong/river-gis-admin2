...
const dragDialog = Vue.directive('dragDialog', {
  bind(el, binding, vnode, oldVnode) {
    ...
    dialogHeaderEl.ondblclick = (e) => {
      let dragDomBody = el.querySelector('.el-dialog__body');
      if (isFullScreen == false) {
        ...
        dragDomBody.style.height = (document.documentElement.clientHeight - 124) + 'px'
