...
const dragModal = Vue.directive('dragModal', {
  bind(el, binding, vnode, oldVnode) {
    ...
    dialogHeaderEl.ondblclick = (e) => {
      let dragDomBody = el.querySelector('.ant-modal-body');
      if (isFullScreen == false) {
        ...
        dragDomBody.style.height = (document.documentElement.clientHeight - 110) + 'px'
