...
export default {
  ...
  mounted() {
    ...
    // 正射影像
    let mapImage = `${this.$store.state.serverUrl}/server/data/admin/regulator/uav/data/mbtiles?year=${year}&month=${month}&day=${day}&x={x}&y={y}&z={z}&X-TENANT-ID=${this.$store.state.tenantId}&Authorization=${token}`
